...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        self.clean[int(pos.getY())][int(pos.getX())] = 1
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        if self.room.isPositionInRoom(temp):
            ...
            self.room.cleanTileAtPosition(temp)
        else:
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    robot_type: class of robot to be instantiated (e.g. StandardRobot or
                RandomWalkRobot)
    """
    steps = [] #append the time-steps of each trial and average
    for trial in range(num_trials):    
        ...
        while clean_frac < min_coverage:
            ...
            trial_steps += 1
            clean_frac = room.getNumCleanedTiles()/room.getNumTiles()
...
#
#pylab.figure(1)
#showPlot1('Number of Robots vs. Time to Clean', 'Number of Robots','Time to Clean')
...
#pylab.figure(2)
#showPlot2('Room Dimension vs. Time to Clean', 'Room Dimension Ratio', 'Time to Clean')
#
